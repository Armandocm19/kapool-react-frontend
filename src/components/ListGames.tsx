...
export const ListGames = () => {
  ...
  return (
    <div className="w-[90%] overflow-hidden flex justify-center flex-col items-center pt-20 pb-20 lg:w-screen">
      ...
      {isLoading
        ...
        <>
          ...
          <div className="w-full h-auto max-h-72 overflow-x-auto overflow-y-auto mt-5 md:w-8/12 md:h-96 md:max-h-[500px] scroll">
            <table className="w-full text-center text-sm font-light mt-10 rounded-lg">
